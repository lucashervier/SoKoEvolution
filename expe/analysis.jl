...
#-------------------------------Expe Configuration-----------------------------#
agent_logs_path = "..//Buboresults//logs//sokoevolution_newfitness//agents.csv"
env_logs_path = "..//Buboresults//logs//sokoevolution_newfitness//envs.csv"
...
function plot_results(title_plot,gen_start,gen_step,gen_end;figure_saving_path="")
    ...
    plot(xaxis="Generation number",yaxis="Fitness",title=title_plot, size=(700,700));
    # plot!(xs,fitness_mean_envs,ribbon=fitness_std_envs,fillalpha=.5,label="Envs fitness")
    plot!(xs,fitness_mean_agents,ribbon=fitness_std_agents,fillalpha=.5,label="Agents fitness");
...
# best_own_rewards = replay_sokolvl(best_agent,best_agent_envs_path)
# # # if your envs are ContinuousSokoLvl
# # best_own_rewards = replay_continuoussokolvl(best_agent,best_agent_envs_path,envs_model)
#
...
#
# # if your envs are SokoLvlIndividual
# last_bestenvs_rewards = replay_sokolvl(last_gen_agent,best_agent_envs_path)
# # # if your envs are ContinuousSokoLvl
# # last_bestenvs_rewards = replay_continuoussokolvl(last_gen_agent,best_agent_envs_path,envs_model)
#
# last_gen_envs_path = Formatting.format("$envs_gen_path//{1:04d}",gen_end)
#
# # if your envs are SokoLvlIndividual
# last_own_rewards = replay_sokolvl(last_gen_agent,last_gen_envs_path)
# # # if your envs are ContinuousSokoLvl
# # last_own_rewards = replay_continuoussokolvl(last_gen_agent,last_gen_envs_path,envs_model)
#
# # if your envs are SokoLvlIndividual
# best_lastenvs_rewards = replay_sokolvl(best_agent,last_gen_envs_path)
# # # if your envs are ContinuousSokoLvl
# # best_lastenvs_rewards = replay_continuoussokolvl(best_agent,last_gen_envs_path,envs_model)
#
# println("best agent generation:$best_agent_gen")
...
#--------------------------------Main------------------------------------------#
plot_results(title_plot,gen_start,gen_step,gen_end)
